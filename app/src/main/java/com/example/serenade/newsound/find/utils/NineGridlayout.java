...
import com.example.serenade.newsound.find.utils.CustomImageView;
import com.example.serenade.newsound.find.utils.ScreenTools;
...
public class NineGridlayout extends ViewGroup {
    ...
    private void layoutChildrenView(){
        ...
        for (int i = 0; i < childrenCount; i++) {
            ...
            ////!!!!!下面一行有问题 需要修改
            //childrenView.setImageUrl(((Image) listData.get(i)).getHeight());
